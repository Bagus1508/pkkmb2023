<div>
    <a id="pak_tahegga" href="{{ url('https://www.instagram.com/taheggaalfath/') }}" class="inline-block px-3 mb-5 lg:mb-0" target="_blank">
        <div class="w-64 lg:w-44 h-[420px] lg:h-80 bg-slate-200 hover:bg-space-textungu rounded-full overflow-hidden transform transition-all hover:-translate-y-2 duration-300 flex flex-col items-center pt-2">
    ...
    <a id="vanessca" href="{{ url('https://www.instagram.com/') }}" class="inline-block px-3 mb-5 lg:mb-0" target="_blank">
        <div class="w-64 lg:w-44 h-[420px] lg:h-80 bg-slate-200 hover:bg-space-textungu rounded-full overflow-hidden transform transition-all hover:-translate-y-2 duration-300 flex flex-col items-center pt-2">
