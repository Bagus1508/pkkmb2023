    ...
    <div id="pengertian" class="flex flex-col lg:flex-row pt-8">
        <div class="lg:w-6/12 lg:mr-4 rounded-lg bg-[#FFECEC] mb-8 px-5 py-4 text-center">
            ...
            <p class="text-justify text-sm mb-2">
                Pengenalan Kehidupan Kampus bagi Mahasiswa Baru (PKKMB) merupakan suatu wadah bagi perguruan tinggi untuk memperkenalkan dan menyiapkan mahasiswa baru ke dalam proses perpindahan dari siswa menjadi mahasiswa yang lebih dewasa dan mandiri, serta mengenalkan kehidupan baru dan memberikan bekal kepada mahasiswa untuk menempuh pendidikan di perguruan tinggi. Universitas Narotama pada tahun ini, juga ikut berpartisipasi dalam kegiatan PKKMB.
            </p>
            <p class="text-justify text-sm mb-2">
                Pada tahun 2023, Universitas Narotama mengambil tema “Pesona Wiracarita: Berani Untuk Bermimpi, Beraksi Dapatkan Prestasi”. Dengan adanya kegiatan PKKMB 2023, mahasiswa dapat memahami pentingnya memiliki mimpi besar dan keberanian untuk mewujudkannya. Melalui tema Pesona Wiracarita: Berani Untuk Bermimpi, Beraksi Dapatkan Prestasi diharapkan mahasiswa dapat menumbuhkan sikap kepahlawanan dalam diri mahasiswa yaitu berani berkorban, jiwa kepemimpinan, bertanggung jawab, menginspirasi, dan penuh kasih sayang sesama manusia dan makhluk tuhan lainnya untuk menyiapkan globalisasi, revolusi industri 4.0 dan society 5.0. Diawali dengan sikap berani bermimpi kemudian mewujudkannya melalui aksi nyata dengan menghasilkan prestasi sebanyak-banyaknya di perkuliahan, sehingga mampu membentuk karakter mahasiswa yang mengedepankan sikap sebagai intelektual yang mengandalkan kecerdasan berpikir, kedewasaan dalam bertutur kata dan bertindak, berbudaya, bermartabat, serta inspiratif.
            </p>
            <p class="text-justify text-sm mb-2">
                Melalui tema PKKMB 2023 ini, peserta diajak untuk bermimpi dengan ketinggian yang tak terbatas. Pesan yang ingin ditanamkan adalah bahwa segala hal yang tampak tidak mungkin dapat dicapai dengan tekad dan usaha yang sungguhsungguh. Wiracarita, dalam segala kebijaksanaannya, mengajarkan kita untuk tidak pernah meragukan diri sendiri saat mencari jalan dan mengikuti impian kita dengan penuh keberanian. Di setiap jengkal perjalanan, kita akan menemukan peluang untuk membuktikan diri. Karena kita adalah para pahlawan masa depan, tak gentar menghadapi tantangan apa pun, dan siap untuk meraih puncak prestasi.
            </p>
            <p class="text-justify text-sm mb-2">
                Perwujudan dari beraksi meraih prestasi yaitu dengan berfokus pada tujuan dan belajar dari pengalaman merupakan kunci dalam menggapai prestasi yang diinginkan. Tentang bagaimana individu atau kelompok telah mengambil langkah-langkah nyata, mengatasi rintangan, dan akhirnya meraih prestasi gemilang dalam berbagai bidang, seperti pendidikan, karier, olahraga, seni, dan banyak lagi.
            </p>
        </div>
