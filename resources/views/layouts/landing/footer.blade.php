        ...
        <div class="flex md:justify-end my-auto">
          <svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" viewBox="0 -4 28 28" fill="none">
            <g clip-path="url(#clip0_503_4764)">
              ...
              <mask id="mask0_503_4764" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="28" height="20">
                <rect x="0.25" y="0.25" width="27.5" height="19.5" rx="1.75" fill="white" stroke="white" stroke-width="0.5"/>
              </mask>
              <g mask="url(#mask0_503_4764)">
              <path fill-rule="evenodd" clip-rule="evenodd" d="M0 10.6667H28V0H0V10.6667Z" fill="#EA233B"/>
              </g>
            </g>
            <defs>
          ...
          <p class="text-xs pl-2 my-auto justify-end">INDONESIA</p>
        </div>
      </div>
    </div>
  </div>
